...
import 'package:investment/data/models/stock.dart';
import 'package:investment/theme/theme.dart';

import '../../utility/ultility.dart';
  ...
  Container _header() {
    return Container(
      ...
      child: Row(
        children: [
          const CircleAvatar(
              radius: 28, backgroundImage: AssetImage('assets/me.jpg')),
